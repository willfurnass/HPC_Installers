...
env_mod_dir="/usr/local/modulefiles/apps/AdmixTools/${admixtools_version}/intel/"
...
cp "${start_dir}/admixtools_env_mod_${admixtools_version}" "${env_mod_dir}/${compiler_short_version}"
